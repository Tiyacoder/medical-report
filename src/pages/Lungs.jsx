  ...
  return (
    <div style={containerStyle}>
      <div style={leftColumnStyle}>
        <div style={lungContainerStyle}>
          <h3 style={lungTitleStyle}>Lung Function</h3>
          
          <div style={testSectionStyle}>
            <div>
              <h4 style={testTitleStyle}>Forced Vital Capacity</h4>
              <div style={testRowStyle}>
                <div style={testColumnStyle}>
                  <p style={columnHeaderStyle}>Predicted Value</p>
                  <p style={columnValueStyle}>54</p>
                </div>
                <div style={testColumnStyle}>
                  <p style={columnHeaderStyle}>Performed Value</p>
                  <p style={columnValueStyle}>54</p>
                </div>
                <div style={testColumnStyle}>
                  <p style={columnHeaderStyle}>% of Predicted</p>
                  <p style={columnValueStyle}>50%</p>
                </div>
              </div>
            </div>

            <div>
              <h4 style={testTitleStyle}>Forced Expiratory Volume/ 1 (FEV1)</h4>
              <div style={testRowStyle}>
                <div style={testColumnStyle}>
                  <p style={columnHeaderStyle}>Predicted Value</p>
                  <p style={columnValueStyle}>54</p>
            ...
            <div>
              <h4 style={testTitleStyle}>FEV1 / FVC %</h4>
              <div style={testRowStyle}>
                <div style={testColumnStyle}>
                  <p style={columnHeaderStyle}>Predicted Value</p>
                  <p style={columnValueStyle}>54</p>
            ...
            <div>
              <h4 style={testTitleStyle}>Peak Expiratory Flow (PEF)</h4>
              <div style={testRowStyle}>
                <div style={testColumnStyle}>
                  <p style={columnHeaderStyle}>Predicted Value</p>
                  <p style={columnValueStyle}>54</p>
      ...
      <div style={rightColumnStyle}>
        ...
        <div style={reportBoxStyle}>
          <h3 style={reportTitleStyle}>Lung Report</h3>
