...
const NervousSystem = () => {
  ...
  const nervousSystemContainerStyle = {
    display: 'flex',
    padding: '12px',
  ...
  const paralysisBoxStyle = {
    ...conditionBoxBaseStyle,
    background: '#09A2E3'
  };

  const mentalBoxStyle = {
    ...conditionBoxBaseStyle,
    background: 'rgba(9, 162, 227, 0.10)'
  };
  ...
  return (
    <div style={containerStyle}>
      <div style={leftColumnStyle}>
        <div style={nervousSystemContainerStyle}>
          <h3 style={nervousSystemTitleStyle}>Nervous System</h3>
          
          <div style={historyBoxStyle}>
            <h4 style={conditionTitleStyle}>History of Fits or Epilepsy</h4>
          ...
          <div style={paralysisBoxStyle}>
            <h4 style={{...conditionTitleStyle, color: '#FFF'}}>Paralysis</h4>
            <p style={paralysisTextStyle}>Lorem ipsum dolor sit amet amet amet met amet consectetur. lorem proin enim pretium nisi quis.</p>
          </div>

          <div style={mentalBoxStyle}>
            <h4 style={conditionTitleStyle}>Mental</h4>
            <p style={{...conditionTextStyle, color: '#818181'}}>Lorem ipsum dolor sit amet amet amet met amet consectetur. lorem proin enim pretium nisi quis.</p>
          </div>
        </div>
      </div>
      ...
      <div style={rightColumnStyle}>
        ...
        <div style={reportBoxStyle}>
          <h3 style={reportTitleStyle}>Report</h3>
