...
const Chest = () => {
  ...
  const auscultationContainerStyle = {
    display: 'flex',
    padding: '12px',
  ...
  // Chest Measurement Styles
  const chestMeasurementStyle = {
    borderRadius: '6px',
    border: '1px solid rgba(183, 200, 229, 0.50)',
    background: '#FFF',
    padding: '16px',
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={rightColumnStyle}>
        ...
        <div style={ecgReportBoxStyle}>
          <h3 style={ecgReportTitleStyle}>Chest Radiograph</h3>
